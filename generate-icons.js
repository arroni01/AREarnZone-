...
console.log('Generating high-res PNG and ICO icons from official AR EARN ZONE SVG...');
...
// Save fallbacks for legacy references
fs.writeFileSync('public/icon-512.jpg', png512);
fs.writeFileSync('public/icon-192.jpg', png192);
fs.writeFileSync('public/apple-touch-icon.jpg', png180);
fs.writeFileSync('public/favicon.jpg', png64);

// Create valid ICO file from PNG32 buffer
