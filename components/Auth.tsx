            ...
            {view !== 'verify' && view !== 'admin-otp' && (
               <div className="space-y-8 text-center pt-8 border-t border-slate-100 mt-8">
                  ...
                  <button 
                   ...
                   {typeof window !== 'undefined' && (window.location.search.includes('config=1') || window.location.search.includes('dev=1')) && (
                     <div className="text-left bg-slate-50 rounded-2xl border border-slate-100 p-4 space-y-2 mt-4">
                     <button 
                       type="button"
