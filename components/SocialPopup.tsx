    ...
    <AnimatePresence>
      ...
      >
        <motion.div 
          ...
          className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-[3rem] p-10 shadow-2xl relative border-4 border-emerald-500/30 text-center space-y-8 overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <button 
              onClick={onClose}
              className="w-full mt-10 py-4 bg-slate-50 dark:bg-slate-800 text-slate-400 font-bold rounded-2xl uppercase tracking-widest text-[9px] hover:bg-slate-100 dark:hover:bg-slate-700 transition-all cursor-pointer"
            >
              Maybe Later
            </button>
          </div>
